...
import { getERC20Contract, getPoolContract, getPriceProviderContract } from 'utils'
...
const Swap = () => {
  ...
  const handleInputSelect = useCallback(
    ...
    [onCurrencySelection, setApprovalSubmitted,  allTokens, selectedTokenA, selectedTokenB]
  )
  ...
  const handleOutputSelect = useCallback(
    ...
    [onCurrencySelection, allTokens, selectedTokenB, selectedTokenA]
  )
