...
import { nDecimals, norValue, PoolItemBaseData, PTPStakedInfo } from 'utils'
  ...
  return (
    <Modal isOpen={isOpen} onDismiss={onDismiss} minHeight={30} maxHeight={90}>
      <div style={{ width: '100%', padding: '30px 30px' }}>
        ...
        <Text fontSize="13px" className='mt-4' color='#888888'>{`Claimable: ${nDecimals(2, norValue(baseData?.vePTPrewardableAmount))} vePTP`}</Text>
        <Row className='mt-1'>
          <Col>
